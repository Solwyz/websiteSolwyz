...
public class ApplicationFormService {
	...
	public ApplicationForm createApplication(String name, String email, String phoneNo, LocalDate dateOfBirth,
			String highestQualification, Long designationId, Long departmentId, MultipartFile resumeFile)
			throws IOException {
	...
	public Map<String, Object> getApplicationsByDepartmentAndDesignation(Long departmentId, Long designationId) {
		List<ApplicationForm> applications = applicationFormRepository.findByDepartmentIdAndDesignationId(departmentId,
				designationId);
